  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        align={align}
        className={cn(
          'z-50 max-w-[240px] rounded-lg border px-3 py-2 text-sm',
          'bg-[var(--glass-bg)] backdrop-blur-[var(--blur-glass)] border-[var(--glass-border)] text-popover-foreground shadow-[var(--shadow-glass-value)]',
